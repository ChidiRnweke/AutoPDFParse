...
class GeminiVisionService(VisionService):
    ...
    def describe_image_content(self, image: str) -> str:
        """
        Describe the content of an image using Google's Gemini vision model.
    ...
    def is_layout_dependent(self, image: str) -> bool:
        """
        Determine if the content in an image is layout-dependent using Google's vision model.
